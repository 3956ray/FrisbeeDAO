...
export const ABIS = {
  "AthleteRegistry": [
    ...
    },
    {
      ...
      "inputs": [
        ...
        {
          "indexed": false,
          "internalType": "enum AthleteRegistry.AthleteStatus",
          "name": "oldStatus",
          "type": "uint8"
        },
        {
      ...
      "outputs": [
        {
          ...
          "internalType": "struct AthleteRegistry.LevelConfig[]",
          "name": "configs",
          "type": "tuple[]"
        }
      ],
      ...
      "outputs": [
        {
          ...
          "internalType": "struct AthleteRegistry.AthleteProfile",
          "name": "",
          "type": "tuple"
        }
      ],
    ...
    },
    {
      ...
      "name": "getAthleteTotalInvestment",
      "outputs": [
        {
          "internalType": "uint256",
      ...
      "outputs": [
        {
          ...
          "internalType": "struct AthleteRegistry.UserLevel",
          "name": "userLevel",
          "type": "tuple"
        }
      ],
      ...
      "outputs": [
        {
          ...
          "internalType": "struct AthleteRegistry.Verifier",
          "name": "",
          "type": "tuple"
        }
      ],
    ...
    },
    {
      ...
      "name": "incrementAchievementCount",
      "outputs": [],
      "stateMutability": "nonpayable",
      "type": "function"
    },
  ...
  "PersonalTokenFactory": [
    ...
    },
    {
      ...
      "outputs": [
        {
          "internalType": "contract AthleteRegistry",
          "name": "",
          "type": "address"
        }
      ],
      ...
      "outputs": [
        {
          ...
          "internalType": "struct PersonalTokenFactory.TokenInfo",
          "name": "",
          "type": "tuple"
        }
      ],
  ...
  "AchievementTracker": [
    ...
    },
    {
      ...
      "inputs": [
        ...
        {
          "indexed": false,
          "internalType": "enum AchievementTracker.AchievementType",
    ...
    {
      "inputs": [],
      "name": "MAX_VERIFIERS_PER_ACHIEVEMENT",
      "outputs": [
        {
          "internalType": "uint256",
          "name": "",
    ...
    },
    {
      ...
      "outputs": [
        ...
        {
          "internalType": "enum AchievementTracker.AchievementStatus",
          "name": "status",
          "type": "uint8"
        },
        {
    ...
    },
    {
      ...
      "name": "requiredVerificationsByType",
      "outputs": [
        {
          "internalType": "uint256",
          "name": "",
    ...
    },
    {
      "inputs": [
        {
          "internalType": "uint256",
          "name": "_newVerificationReward",
          "type": "uint256"
        }
      ],
      "name": "setVerificationReward",
      "outputs": [],
      "stateMutability": "nonpayable",
      "type": "function"
    },
  ...
  "ContentManager": [
    ...
    },
    {
      ...
      "inputs": [
        ...
        {
          "indexed": false,
          "internalType": "enum ContentManager.ContentType",
          "name": "contentType",
          "type": "uint8"
        },
        {
          "indexed": false,
          "internalType": "enum ContentManager.AccessLevel",
          "name": "accessLevel",
          "type": "uint8"
        },
        {
    ...
    },
    {
      ...
      "inputs": [
        ...
        {
          "indexed": false,
          "internalType": "enum ContentManager.ContentStatus",
          "name": "status",
          "type": "uint8"
        }
      ],
